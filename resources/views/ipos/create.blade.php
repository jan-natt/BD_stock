    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Create New IPO</h1>
                    <p class="mt-2 text-gray-600">Launch a new Initial Public Offering for your company</p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-8">
            <form action="{{ route('ipos.store') }}" method="POST" class="space-y-8">
                @csrf
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="symbol" id="symbol" value="{{ old('symbol') }}" required maxlength="20"
                        ...
                        <div class="md:col-span-2">
                            ...
                            <select name="issue_manager_id" id="issue_manager_id" required
                                ...
                                @foreach($issueManagers as $manager)
                                    <option value="{{ $manager->id }}" {{ old('issue_manager_id') == $manager->id ? 'selected' : '' }}>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="description" id="description" rows="4" maxlength="1000"
                                      ...
                                      placeholder="Describe the company and the IPO offering...">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="number" name="price_per_share" id="price_per_share" value="{{ old('price_per_share') }}" required step="0.01" min="0.01"
                        ...
                        <div>
                            ...
                            <input type="number" name="total_shares" id="total_shares" value="{{ old('total_shares') }}" required min="1"
                        ...
                        <div>
                            ...
                            <input type="datetime-local" name="ipo_start" id="ipo_start" value="{{ old('ipo_start') }}" required
                        ...
                        <div>
                            ...
                            <input type="datetime-local" name="ipo_end" id="ipo_end" value="{{ old('ipo_end') }}" required
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="number" name="min_subscription" id="min_subscription" value="{{ old('min_subscription', 1) }}" min="1"
                        ...
                        <div>
                            ...
                            <input type="number" name="max_subscription" id="max_subscription" value="{{ old('max_subscription') }}" min="1"
